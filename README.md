...
[![Twitter Follow](https://img.shields.io/twitter/follow/codewithsadee_?style=social)](https://twitter.com/intent/follow?screen_name=codewithsadee_)
  ...
  <a href="https://deepak-9976.github.io/portfolio/"><strong>➥ Live Demo</strong></a>
...
```bash
sudo git clone https://github.com/deepak-9976/portfolio.git
```

Windows:

```bash
git clone https://github.com/deepak-9976/portfolio.git
```

### Contact

If you want to contact with me you can reach me at [Twitter](https://www.twitter.com/deepak9976).
